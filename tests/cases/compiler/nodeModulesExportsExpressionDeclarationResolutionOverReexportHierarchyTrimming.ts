...
// The "." export only exposes SchemaFactory and ObjectBase (via public.d.ts via beta.d.ts via alpha.d.ts).
// The "./beta" export exposes the full index.d.ts including SchemaFactoryBeta and ObjectBeta (via beta.d.ts via alpha.d.ts).
...
// Expected: package "b" schema.d.ts to import from pkg-a/alpha (while schemaUtils.ts imports pkg-a/beta).
...
export { SchemaFactory, ObjectBase } from "./beta.js";

// @Filename: /node_modules/pkg-a/beta.d.ts
export { SchemaFactory, SchemaFactoryBeta, ObjectBase, ObjectBeta } from "./alpha.js";
