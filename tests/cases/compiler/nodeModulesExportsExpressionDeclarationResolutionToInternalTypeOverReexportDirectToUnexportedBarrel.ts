...
// The "./internal" export exposes the full index.d.ts including ObjectBase_Internal and ObjectBeta_Internal (via internal.d.ts).
// Expected: package "B" schema.d.ts to import from pkg-a/internal or ....
