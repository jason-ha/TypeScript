//// [tests/cases/compiler/nodeModulesExportsExpressionDeclarationResolutionToHiddenTypeOverReexportDirectToUnexportedBarrel.ts] ////
...
//// [schema.d.ts]
declare const AppState_base: typeof import("pkg-a/alpha").ObjectBeta_Hidden;
...
/out/node_modules/pkg-b/src/schema.d.ts(1,53): error TS2694: Namespace '"/node_modules/pkg-a/alpha"' has no exported member 'ObjectBeta_Hidden'.
...
==== /node_modules/pkg-a/internal.d.ts (0 errors) ====
    export * from "./index.js";
...
==== /out/node_modules/pkg-b/src/schema.d.ts (1 errors) ====
    declare const AppState_base: typeof import("pkg-a/alpha").ObjectBeta_Hidden;
                                                              ~~~~~~~~~~~~~~~~~
!!! error TS2694: Namespace '"/node_modules/pkg-a/alpha"' has no exported member 'ObjectBeta_Hidden'.
    export declare class AppState extends AppState_base {
    }
    export {};
