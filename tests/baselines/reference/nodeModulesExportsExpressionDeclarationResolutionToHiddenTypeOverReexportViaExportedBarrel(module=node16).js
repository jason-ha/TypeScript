//// [tests/cases/compiler/nodeModulesExportsExpressionDeclarationResolutionToHiddenTypeOverReexportViaExportedBarrel.ts] ////
...
export class ObjectBase_Hidden {
}
declare const ObjectBeta_Hidden_base: {
    new (): ObjectBase_Hidden;
};
export class ObjectBeta_Hidden extends ObjectBeta_Hidden_base {
}
export {};
//// [schemaUtils.d.ts]
import { SchemaFactoryBeta } from "pkg-a/alpha";
